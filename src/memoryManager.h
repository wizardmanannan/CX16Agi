...
#define ALLOCATION_ARRAY_SIZE (TINY_NO_SEGMENTS + EXTRA_SMALL_NO_SEGMENTS + SMALL_NO_SEGMENTS + MEDIUM_NO_SEGMENTS + LARGE_NO_SEGMENTS)
...
#define PICTURE_CODE_OVERFLOW_BANK 0x8
#define IRQ_BANK 6
...
#define DEPENDENCY_RESOLVER_BANK 0x4
#define OBJ_SHOW_BANK 0x11
